...
var subnetRangeIPSuccessString string= "startIP: 192.168.100.10\nendIP: 192.168.100.500"
//var subnetRangeIPFailureString string= "Error: cq.98.42.1234 is not a valid IPv4\n\n"
...
var subnetPickersNoArgErrorString string ="Error: drpcli subnets pickers [subnetName] [IP] requires 2 arguments\n\n"
var subnetPickersTooManyArgErrorString string ="Error: drpcli subnets pickers [subnetName] [IP] requires 2 arguments\n\n"
...
func TestSubnetCli(t *testing.T) {
  tests := []CliTest{
    ...
    CliTest{false,false,[]string{"subnets", "range", "john", "192.168.100.10", "192.168.100.500"},noStdinString,subnetRangeIPSuccessString,noErrorString},
    ...
    CliTest{false,true, []string{"subnets", "pickers", "john", "june", "test1,test2,test3"}, noStdinString,noContentString,subnetPickersTooManyArgErrorString},
